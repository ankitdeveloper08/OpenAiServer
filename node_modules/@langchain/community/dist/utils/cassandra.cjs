...
exports.CasssandraClientFactory = void 0;
...
class CasssandraClientFactory {
    ...
    static async processAstraArgs(args) {
        ...
        await CasssandraClientFactory.setAstraBundle(astraArgs, modifiedArgs.cloud.secureConnectBundle);
        ...
        if (typeof scbPath === "string") {
            try {
                ...
                if (fileAgeInDays > 360) {
                    await CasssandraClientFactory.downloadAstraSecureConnectBundle(astraArgs, scbPath);
                }
            }
            catch (error) {
...
exports.CasssandraClientFactory = CasssandraClientFactory;
